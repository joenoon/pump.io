(function() {
  var EventEmitter, Pump, clientVersion, connect, express, fs, io, redis, sys, url;
  ...
  Pump = (function() {
    ...
    function Pump(options) {
      ...
      if (options.server_sweeper === 'false') {
        options.server_sweeper = false;
      }
      if (options.server_sweeper === 'true') {
        options.server_sweeper = true;
      }
      (_ref = options.server_sweeper) != null ? _ref : options.server_sweeper = true;
      this.server_sweeper = options.server_sweeper;
